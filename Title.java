...
public class Title extends JPanel implements MouseListener, MouseMotionListener {
	...
	private BufferedImage title, play;
	...
	bounds = new Rectangle(Window.WIDTH/2 - 50, Window.HEIGHT/2 - 270, 100, 80);
	this.window = window;
	}
	public void paintComponent(Graphics g){
		...
		g.drawImage(title, Window.WIDTH/2 - title.getWidth()/2, Window.HEIGHT/2 - title.getHeight()/2 - 70, null);
		
		if(bounds.contains(mouseX, mouseY))
			g.drawImage(playButton[0], Window.WIDTH/2 - 50, Window.HEIGHT/2 - 270, null);
		else
			g.drawImage(playButton[1], Window.WIDTH/2 - 50, Window.HEIGHT/2 - 270, null);	
	}
